...
const Footer = () => {
  ...
  <div>
    <h3 className="text-2xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-teal-400">
  ...
  <div>
    ...
    <div className="space-y-4">
      <div className="flex items-center space-x-3">
        ...
        <span className="text-gray-300">onestop@gmail.com</span>
      </div>
      <div className="flex items-center space-x-3">
        <Phone className="w-5 h-5 text-yellow-400" />
        <span className="text-gray-300">+91 93455 752027</span>
      </div>
      <div className="flex items-center space-x-3">
  ...
  <div>
    ...
    <ul className="space-y-3 text-gray-300">
      ...
      <li className="flex items-center space-x-2">
        <span className="text-yellow-400">▹</span>
        <span>Animator / Motion Designer</span>
      </li>
    </ul>
  </div>
</div>
